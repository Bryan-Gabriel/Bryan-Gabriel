...
Meu nome é Bryan sou estudante de **Engenharia de Software**, no início da minha jornada e movido por uma paixão genuína por tecnologia. Meu maior interesse atual está em **cibersegurança**.

Atualmente, estou colocando a mão na massa em um **projeto profissional de cooparticipação**, unindo desenvolvimento full stack com boas práticas de segurança desde o início do design.
